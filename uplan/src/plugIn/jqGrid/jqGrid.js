/**
*
* @license Guriddo jqGrid JS - v5.1.1 - 2016-10-12
	...
	styleUI : {
		...
		Uplan : {
			common : {
				...
				active : "up-active",
				error : "up-bg-danger",
				button : "up-btn up-btn-default",
				content : ""
			},
			base : {
				entrieBox : "",
				viewBox : "up-table-responsive",
				headerTable : "up-table up-table-bordered",
				headerBox : "",
				rowTable : "up-table up-table-bordered",
				rowBox : "",
				footerTable : "up-table up-table-bordered",
				footerBox : "",
				headerDiv : "",
				gridtitleBox : "",
				customtoolbarBox : "",
				...
				pagerTable : "up-table",
				toppagerBox : "",
				pgInput : "up-form-control",
				pgSelectBox : "up-form-control",
				pgButtonBox : "",
				icon_first : "icon-u-step-forward",
				icon_prev : "icon-u-backward",
				icon_next: "icon-u-forward",
				icon_end: "icon-u-step-backward",
				icon_asc : "icon-u-up-dir-lg",
				icon_desc : "icon-u-down-dir-lg",
				icon_caption_open : "glyphicon-circle-arrow-up",
				icon_caption_close : "glyphicon-circle-arrow-down"
			},
			modal : {
				modal : "up-modal-content",
				header : "up-modal-header",
				title : "up-modal-title",
				content :"up-modal-body",
				resizable : "ui-resizable-handle ui-resizable-se",
				icon_close : "icon-u-remove",
				icon_resizable : "icon-u-resize"
			},
			celledit : {
				inputClass : 'up-form-control'
			}, 
			inlinedit : {
				inputClass : 'up-form-control',
				icon_edit_nav : "icon-u-edit",
				icon_add_nav : "icon-u-plus",
				icon_save_nav : "icon-u-save",
				icon_cancel_nav : "icon-u-remove"
			},
			formedit : {
				inputClass : "up-form-control",
				icon_prev : "icon-u-step-forward",
				icon_next : "icon-u-step-backward",
				icon_save : "icon-u-save",
				icon_close : "icon-u-remove",
				icon_del : "icon-u-trash",
				icon_cancel : "icon-u-remove"
			},
			navigator : {
				icon_edit_nav : "icon-u-edit",
				icon_add_nav : "icon-u-plus",
				icon_del_nav : "icon-u-trash",
				icon_search_nav : "icon-u-search",
				icon_refresh_nav : "icon-u-arrows-cw",
				icon_view_nav : "icon-u-info",
				icon_newbutton_nav : "icon-u-new-window"
			},
			grouping : {
				icon_plus : 'icon-u-right-dir-lg',
				icon_minus : 'icon-u-down-dir-lg'
			},
			filter : {
				table_widget : 'up-table up-table-condensed',
				srSelect : 'up-form-control',
				srInput : 'up-form-control',
				menu_widget : '',
				icon_search : 'icon-u-search',
				icon_reset : 'icon-u-arrows-cw',
				icon_query :'icon-u-message'
			},
			subgrid : {
				icon_plus : 'icon-u-right-dir-lg',
				icon_minus : 'icon-u-down-dir-lg',
				icon_open : 'icon-u-indent-left'
			},
			treegrid : {
				icon_plus : 'icon-u-right-dir-lg',
				icon_minus : 'icon-u-down-dir-lg',
			...
			fmatter : {
				icon_edit : "icon-u-edit",
				icon_add : "icon-u-plus",
				icon_save : "icon-u-save",
				icon_cancel : "icon-u-remove",
				icon_del : "icon-u-trash"
			},
			colmenu : {
				menu_widget : '',
				input_checkbox : "",
				filter_select: "up-form-control",
				filter_input : "up-form-control",
				icon_menu : "icon-u-menu",
				icon_sort_asc : "icon-u-sort-by-alphabet",
				icon_sort_desc : "icon-u-sort-by-alphabet-alt",
				icon_columns : "icon-u-list-alt",
				icon_filter : "icon-u-filter",
				icon_group : "icon-u-align-left",
				icon_freeze : "icon-u-align-horizontal",
				icon_move: "icon-u-move"
			}
		}
	}
});
	...
	return this.each( function() {
		...
		setColWidth = function () {
			...
			if(ts.p.shrinkToFit===true && vc > 0) {
				...
				ts.p.tblwidth = ts.p.width-1;//修改ts.p.tblwidth = initwidth+cr+brd*vc+gw;
		...
		bstw = ts.p.styleUI === 'Uplan' && !isNaN(ts.p.height) ? 2 : 0;
		thead = null;
		...
		$(grid.bDiv)
			...
			.addClass("ui-jqgrid-bdiv scroll")
...
$.jgrid.extend({
	...
	setGridWidth : function(nwidth, shrink) {
		return this.each(function(){
			if (!this.grid ) {return;}
			var $t = this, cw,
			initwidth = 0, brd=$.jgrid.cell_width ? 0: $t.p.cellLayout, lvc, vc=0, hs=false, scw=$t.p.scrollOffset, aw, gw=0, cr, bstw = $t.p.styleUI === 'Uplan' ? 2 : 0;
			...
			if(shrink===true) {
				...
				$t.p.tblwidth = nwidth-1;//修改$t.p.tblwidth = initwidth+cr+brd*vc+gw;
...
h.w.css({"top":($(window).height()-h.w.height())/2,"left":($(window).width()-h.w.width())/2});//修改 新增
